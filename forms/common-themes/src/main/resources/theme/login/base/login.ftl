...
<@layout.registrationLayout bodyClass=""; section>
    ...
    <#elseif section = "form">
    <form id="kc-form-login" action="${url.loginAction?html}" method="post">
    ...
    <div id="kc-login-actions">
        ...
        <#if realm.resetPasswordAllowed>
            <p>Forgot <a href="${url.loginUsernameReminderUrl?html}">Username</a> / <a href="${url.loginPasswordResetUrl}">Password</a>?</p>
        </#if>
    </div>
    </#if>
